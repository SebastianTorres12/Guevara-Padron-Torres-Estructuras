...
//CASTEO
int ValidacionDatos::casteoEnteros(char* dato){	
	int valor;
	strcpy(dato,lecturaEnteros("\nIngresar el valor a convertir a entero : "));
...
//CASTEO
double ValidacionDatos::casteoReales(char* dato){	
	double valor;
	strcpy(dato,lecturaReales("\nIngresar el valor a convertir a real : "));
